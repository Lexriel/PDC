...
% Nous supposons ici que nous sommes en
%   \textsc{c-ansi}, ainsi \verb?convert? peut renvoyer une structure
%   \verb?MatriceCreuse_t?.
...
\end{enumerate}
\paragraph{Indication~:} Vous pouvez utiliser les fonctions classiques
